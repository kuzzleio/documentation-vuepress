...
If this is not already the case, the data collection must first be created, using the [storage](/plugins/1/accessors/storage) accessor.
...
| Arguments | Type              | Description                                                                            |
| --------- | ----------------- | -------------------------------------------------------------------------------------- |
| `query`   | <pre>object</pre> | Search query, using Elasticsearch [query format](/guide/1/elasticsearch/basic-queries) |
| `options` | <pre>object</pre> | Optional arguments                                                                     |
