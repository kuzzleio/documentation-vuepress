...
This method is non-queuable, meaning that during offline mode, it will be discarded and the callback will be called with an error. <a href="/core/1/guide/essentials/user-authentication/#local-strategy">Learn more.</a>
</div>
