...
Before going through this tutorial, you should have a Kuzzle server running. Please refer to the [Running Kuzzle Tutorial](https://docs.kuzzle.io/core/1/guide/getting-started/running-kuzzle/) if you don't have one yet.
...
<div class="alert alert-success">
    ...
    <a href="/core/1/guide/essentials/installing-console">here</a> to see how you can use the
...
- follow our guide to learn how to implement <a href="/core/1/guide/essentials/user-authentication/#local-strategy">basic authentication</a>
- follow our guide to learn how to implement <a href="/core/1/guide/essentials/security/">manage users and setup fine-grained access control</a>
