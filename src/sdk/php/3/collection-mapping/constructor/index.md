...
| ------------ | ------------------------------------ | --------------------------------- |
| `Collection` | [Collection](/sdk/php/3/collection/) | An instantiated Collection object |
...
**Note:** the `headers` property is inherited from the provided [Collection](/sdk/php/3/collection/) object and can be overrided
