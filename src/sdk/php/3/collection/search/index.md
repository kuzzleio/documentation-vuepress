...
Instead, the recommended way to process a large number of documents is to use [`Collection.scroll`](/sdk/php/3/collection/scroll/) or, easier, [`SearchResult.fetchNext`](/sdk/php/3/search-result/fetch-next).

See [`SearchResult.fetchNext`](/sdk/php/3/search-result/fetch-next/#how-to-process-every-document-of-a-collection) for an example of how to process every document of a collection.
