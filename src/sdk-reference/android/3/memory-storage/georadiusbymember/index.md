...
Returns the members (added with [geoadd](/sdk-reference/android/3/memory-storage/geoadd)) of a given key inside the provided geospatial radius, centered around one of a key's member.
