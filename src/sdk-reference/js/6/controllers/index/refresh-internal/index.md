...
The `refreshInternal` action forces a [refresh](//sdk-reference/js/6/index/refresh), on the internal index, making the documents available to search immediately.
