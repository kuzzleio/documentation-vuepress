...
**Note:** We recommend you instantiate a Collection object by calling [Kuzzle.collection](/sdk-reference/js/5/kuzzle/collection) rather than using the constructor directly
