...
Instead, the recommended way to process a large number of documents is to use [`Collection.scroll`](/sdk-reference/js/5/collection/scroll/) or, easier, [`SearchResult.fetchNext`](/sdk-reference/js/5/search-result/fetch-next).

See [`SearchResult.fetchNext`](/sdk-reference/js/5/search-result/fetch-next/#how-to-process-every-document-of-a-collection) for an example of how to process every document of a collection.
...
Returns an instance of [SearchResult](/sdk-reference/js/5/search-result).
