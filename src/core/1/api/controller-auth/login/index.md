...
- `strategy`: the name of the authentication [strategy](/core/1/guide/kuzzle-depth/authentication/#authentication) used to log the user in.

### Optional:

- `expiresIn`: set the expiration duration (default: depends on [Kuzzle configuration file](/core/1/guide/essentials/configuration/))
...
- `_id`: user's [kuid](/core/1/guide/kuzzle-depth/authentication#the-kuzzle-user-identifier)
