...
This route is faster than the `document:m*` routes family (e.g. [document:mCreate](/api/1/controller-document/m-create)), but no real-time notifications will be generated, even if some of the documents in the import match subscription filters.
