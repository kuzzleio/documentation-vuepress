...
In both cases the configuration is the same and you'll be able to select which <a :href="`${$site.base}core/1/guide/guides/essentials/installing-console/#connect-to-kuzzle`">Kuzzle</a> installation that you want to manage.
