...
If the basic validation functionality doesn't meet your requirements, you can take advantage of [Koncorde](/koncorde/1) to create complex validation specifications.
...
In the example above, we used both the `exists` operator and the `or` operator to build our validation rule. For more information take a look at our [Koncorde Reference](/koncorde/1/essentials/terms/#exists-default).
