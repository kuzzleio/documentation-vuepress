...
Users can be created by either using the [Kuzzle Admin Console](/core/1/guide/guides/essentials/installing-console/) or the [API](/api/1/controller-security/create-user/).
...
- [User credentials](/core/1/guide/guides/essentials/user-authentication/#user-credentials): If no credentials are provided, then the user cannot [login](/api/1/controller-auth/login/)
